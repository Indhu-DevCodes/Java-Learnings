package Oops.Polymorphism.overriding;
    ...
    /*
    -- Overriding depends on objects, static stuffs does not depends on objects, hence we cannot override static methods
...
public class OverridingwithStaticMethods {
    ...
    public static void main(String[] args) {
       ...
       obj2.boxColor();
        ...
        A obj3 = new B();   //IF any method has been overridden in B class then that can be executed
